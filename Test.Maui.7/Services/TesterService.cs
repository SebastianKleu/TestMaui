...
[Service(Name = "com.maui.seven", Exported = true)]
public class TesterService : Service
{
    private readonly IServiceNotification _serviceNotification;

    private const int ServiceRunningNotificationId = 10007;
    ...
    public override void OnCreate()
    {
        ...
        try
        {
            var notification = _serviceNotification.ReturnNotification("Test service 7", "Net 7 Service running");
